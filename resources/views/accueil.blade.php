...
<section class="not-found-home" aria-labelledby="not-found-title">
    <div class="not-found-content">
        <span class="not-found-code">404 · OUPS</span>
        <h1 id="not-found-title">Cette page n’est pas<br><em>au rendez-vous.</em></h1>
...
<section class="hero-section" aria-labelledby="hero-title">
    <div class="hero-copy">
        @if (session('not_found'))
            <div class="route-notice" role="status"><span>↗</span>{{ session('not_found') }}</div>
        @endif
        @auth
            <div class="user-greeting"><span class="greeting-mark">✦</span><span>Bonjour, {{ Auth::user()->prenom ?: Auth::user()->nom }}.</span></div>
        @endauth
        <span class="eyebrow"><span class="eyebrow-dot"></span> Sentinel IA · le réflexe quand quelque chose cloche</span>
        <h1 id="hero-title">Retrouvez la<br><em>sérénité numérique.</em></h1>
...
<section class="home-section" aria-labelledby="features-title">
    <div class="section-heading"><div><span class="eyebrow">Les bons réflexes, au bon moment</span><h2 id="features-title">Un doute sur un message ? On vérifie avec vous.</h2></div><p>Trois portes d’entrée pour comprendre ce qui se cache derrière un numéro, un lien ou une promesse trop belle.</p></div>
    <div class="features-grid">
        <article class="card feature-card"><span class="feature-index"></span><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2C6.58 2 2 6.58 2 12s4.58 10 10 10 10-4.58 10-10S17.42 2 12 2m0 18c-4.34 0-8-3.66-8-8s3.66-8 8-8c1.82 0 3.51.65 4.87 1.71l-1.41 1.41A5.9 5.9 0 0 0 12 6c-1.58 0-3.09.63-4.23 1.77S6 10.41 6 12s.63 3.09 1.77 4.23S10.41 18 12 18s3.09-.63 4.23-1.77l-1.41-1.41c-1.53 1.53-4.1 1.53-5.63 0-.76-.76-1.18-1.76-1.18-2.82s.42-2.05 1.18-2.82c1.28-1.28 3.3-1.47 4.82-.6l-1.49 1.49c-.16-.05-.33-.08-.51-.08-1.08 0-2 .92-2 2s.92 2 2 2 2-.92 2-2c0-.18-.03-.34-.08-.51l4.36-4.36C19.36 8.48 20 10.17 20 11.99c0 4.34-3.66 8-8 8Z"/></svg><h3>Testez un message suspect</h3><p>Soumettez un SMS, une image, un lien ou un numéro et obtenez des indices concrets sur son niveau de risque.</p></article>
        <article class="card feature-card"><span class="feature-index"></span><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 2H2v19c0 .55.45 1 1 1h19v-2H4zM19 18c.55 0 1-.45 1-1V5c0-.55-.45-1-1-1h-4c-.55 0-1 1-1 1v12c0 .55.45 1 1 1zm-3-12h2v10h-2zm-5 12c.55 0 1-.45 1-1v-7c0-.55-.45-1-1-1H7c-.55 0-1 1-1 1v7c0 .55.45 1 1 1zm-3-7h2v5H8z"/></svg><h3>Fouillez les arnaques déjà répertorié</h3><p>Comparez une adresse, un email ou un numéro avec les signalements vérifiés de la communauté.</p></article>
        <article class="card feature-card"><span class="feature-index"></span><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M16.13 9.64c-.17-.95-1-1.64-1.97-1.64H9.83c-.97 0-1.79.69-1.97 1.64L6.16 19H3.99v2h16v-2h-2.17l-1.7-9.36ZM8.19 19l1.64-9h4.33l1.64 9H8.2ZM11 4.5V6h2V3h-2zm8 6.5v2h3v-2zM5 12v-1H2v2h3z"/></svg><h3>Faire circuler l’alerte</h3><p>Un signalement bien documenté peut éviter la prochaine victime. Partagez ce que vous avez vu.</p></article>
    </div>
</section>
